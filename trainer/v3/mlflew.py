...
# # 👇 ALWAYS do this
# mlflow.set_tracking_uri("sqlite:///C:/Users/user/Desktop/ML/Production-Level/mlflow.db")
# mlflow.set_experiment("dataset_registry")

# with mlflow.start_run(run_name="dataset_v3-without-test"):
#     mlflow.log_artifact(CSV_PATH, artifact_path="datasets")

# dataset_mlflow_audit.py
import os
import hashlib
import pandas as pd
import numpy as np
...
EXPERIMENT_NAME = "dataset_audit_v3"
